...
def run(sim, sim_rule, move_filter, in_tree_knowledge):
    ...
    con = GtpConnection(Nogo(num_sim, sim_rule, move_filter, in_tree_knowledge), board)
...
def parse_args():
    ...
    parser.add_argument('--sim', type=int, default=500, help='number of simulations per move, so total playouts=sim*legal_moves')
